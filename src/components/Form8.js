        ...
        >
            <div className="row form-group-row">
                ...
                <div className="col-12 col-lg-3">
                    <FormField key='form8FechaReunion'
                        name="fechaReunion" 
                        placeholder="Fecha" 
                ...
                <div className="col-12 col-lg-3">
                    <FormField key='form8HoraReunion'
                        name="horaReunion" 
                        placeholder="Fecha" 
                        className="form-input-content"
                        type="time"
            ...
            <div className="row form-group-row">
                ...
                <div className="col-12 col-lg-3">
                    <FormField key='form8LugarReunion'
                        name="lugarReunion" 
                        placeholder="Lugar" 
                        className="form-input-content"
                        type="text"
            ...
            <div className="row form-group-row">
                ...
                <div className="col-12 col-lg-3">
                    <FormField key='form8NombreTutorPractica'
                ...
                <div className="col-12 col-lg-3">
                    <FormField key='form8NombreSupervisorCampo'
                ...
                <div className="col-12 col-lg-3">
                    <FormField key='form8NombreEstudiantePracticante'
            ...
            <div className="row form-group-row">
                ...
                <div className="col-12 col-lg-3">
                    <FormField key='form8FechaCompromiso1'
                ...
                <div className="col-12 col-lg-3">
                    <FormField key='form8FechaCompromiso2'
                ...
                <div className="col-12 col-lg-3">
                    <FormField key='form8FechaCompromiso3'
                ...
                <div className="col-12 col-lg-3">
                    <FormField key='form8FechaCompromiso4'
